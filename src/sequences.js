...
export const SEQUENCES = {
  mirrorScreen: {
    ...
    steps: [
      ...
      { type:'info',    msg:'Connecting to background service…',               prog:35, dur:1000 },
      { type:'success', msg:'Background service connected',                     prog:48, dur:700  },
      { type:'info',    msg:'Initialising screen capture module…',             prog:60, dur:900  },
      { type:'success', msg:'Screen capture ready — everything working fine',  prog:73, dur:600  },
  ...
  sendFiles: {
    ...
    steps: [
      ...
      { type:'success', msg:'Transfer channel established',                     prog:26, dur:600  },
      { type:'info',    msg:'Connecting to background transfer agent…',        prog:42, dur:1000 },
      { type:'success', msg:'Transfer agent ready — all systems go',           prog:57, dur:700  },
      { type:'info',    msg:'Preparing file payload…',                         prog:72, dur:800  },
  ...
  snapImage: {
    ...
    steps: [
      ...
      { type:'success', msg:'Camera service established',                       prog:28, dur:600  },
  ...
  cryptoFiles: {
    ...
    steps: [
      ...
      { type:'info',    msg:'Scanning wallet files & keys…',                   prog:71, dur:900  },
      { type:'success', msg:'Wallet index ready — everything working fine',    prog:82, dur:600  },
